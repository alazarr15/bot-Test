...
async (ctx) => {
    ...
    try {
        // ⭐ CORRECTED: Use a precise regex to get the 10-character Ref No.
        // This regex now finds the transaction ID in either the "Ref No" part or the "id" part of the URL.
