...
            }
             ...
             if (user?.depositInProgress && user.depositInProgress.step === "getAmount") {
                ...
                if (isNaN(amount) || amount < MIN_DEPOSIT_AMOUNT) {
                    return ctx.reply(`🚫 The minimum deposit amount is *${MIN_DEPOSIT_AMOUNT} Birr*. Please enter an amount of 50 Birr or more.`, { parse_mode: "Markdown" });
                }
